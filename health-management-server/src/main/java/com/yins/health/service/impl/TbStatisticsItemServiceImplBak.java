...
//public class TbStatisticsItemServiceImplBak extends ServiceImpl<TbStatisticsItemDao, TbStatisticsItem> implements TbStatisticsItemService {
//    @Autowired
...
//        int counts = 0;
//        Set<TbDept> uniqueSet = new HashSet<>();
...
//            List<TbUserDept> tbUserDepts = tbUserDeptDao.selectList(
//                    new LambdaQueryWrapper<TbUserDept>()
//                            .eq(TbUserDept::getUserId, tbStatistics.getUserId())
//                            .select(TbUserDept::getDeptId)
//            );
//            for (TbUserDept tbUserDept : tbUserDepts) {
//                TbDept tbDept = tbDeptDao.selectById(tbUserDept.getDeptId());
//                uniqueSet.add(tbDept);
//                item.setDept(tbDept.getName());
//                saveList.add(item);
//            }
//            //sss(tbStatistics.getUserId(),item);
//        }
//        for (TbDept tbDept : uniqueSet) {
//            item = new TbStatisticsItem();
//            item.setIsDept(1);
//            item.setUserName(tbDept.getName());
//            saveList.add(item);
//        }
//        this.saveBatch(saveList);
//    }
//    /*private Map<Integer,List<TbStatisticsItem>> map = new HashMap<>();
//    public void sss(String userId,TbStatisticsItem item){
//        List<TbUserDept> tbUserDepts = tbUserDeptDao.selectList(
//                new LambdaQueryWrapper<TbUserDept>()
//                        .eq(TbUserDept::getUserId, userId)
//                        .select(TbUserDept::getDeptId)
//        );
//        for (TbUserDept tbUserDept : tbUserDepts) {
//            List<TbStatisticsItem> orDefault = map.getOrDefault(tbUserDept.getDeptId(), new ArrayList<>());
//            orDefault.add(item);
//            map.put(tbUserDept.getDeptId(), orDefault);
//        }
//    }*/
//    @Override
